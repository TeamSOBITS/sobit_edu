#ifndef SOBIT_edu_JOINT_CONTROLLER_H_
#define SOBIT_edu_JOINT_CONTROLLER_H_
...
#include "sobit_edu_library/sobit_edu_library.hpp"
...
class JointController : public rclcpp::Node {
 public:
  JointController(
      const std::string& node_name = "sobit_edu_joint_controller");
  ~JointController();
...
inline void sobit_edu::JointController::setJointTrajectory(
    trajectory_msgs::msg::JointTrajectory* jt,
    const std::string& joint_name,
    const double rad,
    const int32_t sec) {
...
inline void sobit_edu::JointController::addJointTrajectory(
    trajectory_msgs::msg::JointTrajectory* jt,
    const std::string& joint_name, 
    const double rad, 
    const int32_t sec) {
...
// TODO: send publisher
inline void sobit_edu::JointController::checkPublishersConnection(
    const rclcpp::Publisher<trajectory_msgs::msg::JointTrajectory>::SharedPtr& pub) {
...
inline void sobit_edu::JointController::declarePoseParams(
    const std::string& prefix) {
...
inline void sobit_edu::JointController::setPoseParams(
    const std::string& prefix,
    std::vector<Pose>& poses) {
  Pose pose;
...
inline void sobit_edu::JointController::callbackArmCurr(
    const sobits_interfaces::msg::CurrentStateArray::SharedPtr msg) {
...
#endif  // SOBIT_edu_JOINT_CONTROLLER_H_