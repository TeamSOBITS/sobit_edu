...
inline void sobit_edu::SobitTurtlebotController::checkPublishersConnection ( const ros::Publisher& pub ) {
...
inline void sobit_edu::SobitTurtlebotController::callbackOdometry ( const nav_msgs::OdometryConstPtr &odom_msg ) { curt_odom_ = *odom_msg; }

inline double sobit_edu::SobitTurtlebotController::geometryQuat2Yaw( const geometry_msgs::Quaternion& geometry_quat ) {
    tf::Quaternion quat;
...
inline double sobit_edu::SobitTurtlebotController::rad2Deg ( const double rad ) { return rad * 180.0 / M_PI; }

inline double sobit_edu::SobitTurtlebotController::deg2Rad ( const double deg ) { return deg * M_PI / 180.0; }
