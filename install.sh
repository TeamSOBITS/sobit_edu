...
echo "# SOBIT EDU environment variables" >> /home/$USERNAME/.bashrc
echo "export DXL_SE_PORT=`realpath /dev/serial/by-id/usb-BestTechnology_E143_E143-if00-port0`" >> /home/$USERNAME/.bashrc
echo "export KOBUKI_SE_PORT=`realpath /dev/serial/by-id/usb-Yujin_Robot_iClebo_Kobuki_kobuki_AL03ERLV-if00-port0`" >> /home/$USERNAME/.bashrc
echo "" >> /home/$USERNAME/.bashrc
